...
if (isset($_POST['register']))
{
	...
	if (!$registrationError)
	{
		...
		{
			//save data and log in
			AddUser($email, $password, $firstname, $lastname, $age, $gender, $city, $state, $country);
			$_SESSION['user'] = $email;
...
<body<?php if ($registrationError) echo " onload=\"FormValidation(document.forms[1]);\""; ?>>

<div id="main">

	<div id="topbar">
		Already have an account? &nbsp;&nbsp;&nbsp;
		<span id="signinButton" onClick="document.getElementById('signin<?php if ($signinFailed) echo "Display"; ?>').style.display = 'block';">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sign In&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</span>
	</div>
	<div id="signin<?php if ($signinFailed) echo "Display"; ?>">
		<form method="post" style="position: relative; left: 700px;">
		<?php
			if ($signinFailed)
			{
				echo "<div style=\"color: red; font-weight: bold; padding-bottom: 5px;\">";
				echo "&nbsp;Error: Login failed</div>";
			}
		?>
		<table>
			<tr><td>Email:</td><td><input style="width: 125px" type="text" name="email" /></td></tr>
			<tr><td>Password:&nbsp;&nbsp;</td><td><input style="width: 125px" type="password" name="password" /></td></tr>
			<tr><td>&nbsp;</td><td><input style="width: 125px; background-color: #000066; color: white;" type="submit" name="signin" value="Sign In" /></td></tr>
		</table>
		</form>
	</div>
	...
	<div id ="body">
		...
		<div id="signup">
			...
			?>
			<form id="signupForm" method="post" onSubmit="return FormValidation(this)" >
			<table>
			<tr>
				<td>Email address:</td>
